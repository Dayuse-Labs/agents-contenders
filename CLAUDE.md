...
- **Lyria content blocking**: never put a performer's name in the prompt or have a rapper sing their own name in the lyrics — it triggers `PROHIBITED_CONTENT` (anti-voice-cloning). `VoiceSpec` deliberately has no `name` field.
